            ...
            "compile": function(element, attrs) {
                ...
                markAsSubmitted = function(form) {
                    ...
                    nestedForms = _.filter(_.values(form), function(input) {
                        var _ref, _ref1;
                        return (input != null ? (_ref = input.$$element) != null ? (_ref1 = _ref[0]) != null ? _ref1.tagName : void 0 : void 0 : void 0) === "FORM" && __indexOf.call(forms, input) < 0;
                    });
                    _results = [];
                ...
                return function(scope, element, attrs, formCtrl) {
                    return element.on("submit", function(event) {
                        var finallyProm, promise, resource, result;
                        ...
                        if (promise && angular.isObject(promise)) {
                            ...
                            finallyProm = promise["finally"](function() {
