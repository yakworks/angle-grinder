...
modules = {
    ...
    xeditable {
      resource url: [plugin: "angleGrinder", dir: "angleGrinder/scripts", file: "angular.xeditable.min.js"]
      resource url: [plugin: "angleGrinder", dir: "angleGrinder/styles", file: "angular.xeditable.min.css"]
    }
    ...
    angleGrinder {
        resource url: [plugin: plugin, dir: "angleGrinder/styles", file: "style.css"]
        ...
        resource url: [plugin: plugin, dir: "angleGrinder/js", file: "application.js"]
        resource url: [plugin: plugin, dir: "angleGrinder/js", file: "modules/resources.js"]
    }
