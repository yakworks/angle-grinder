(function() {
    ...
    common = angular.module("angleGrinder.common", [ "ui.bootstrap.modal", "ui.bootstrap.popover", "angleGrinder.resources", "duScroll" ]);
...
(function() {
    ...
    app.provider("agLocalDateTimeFilter", function() {
        return {
            "$get": [ "$filter", "IsFalsyServ", function() {
    ...
    app.directive("addEmptyOption", function() {
        return {
            ...
            "link": function(scope, element, attrs) {
                var emptyOption;
                emptyOption = attrs.emptyOption != null ? JSON.parse(attrs.emptyOption.replace(/[']/g, '"')) : {
                    "id": "",
                    "name": ""
                };
                element.prepend(angular.element("<option value=''>" + emptyOption.name + "</option>"));
                if (scope.addEmptyOption != null && scope.addEmptyOption.length > 0) {
                    if (!_.find(scope.addEmptyOption, {
                        "id": emptyOption.id
                    })) {
        ...
        return {
            ...
            "link": function($scope, element, attrs) {
                ...
                $scope.tagArray = function() {
                    ...
                    return $scope.tags.replace(".", "").split(/[\s,+]+/).filter(function(tag) {
                        return tag !== "";
                    });
                };
                $scope.addTag = function() {
                    ...
                    if (_ref = $scope.tagVal, __indexOf.call(tagArray, _ref) < 0) {
                        if ($scope.tagVal.indexOf(",") > -1 || $scope.tagVal.indexOf("+") > -1 || $scope.tagVal.indexOf(" ") > -1) {
                            tagArray = tagArray.concat(_.map($scope.tagVal.split(/[\s,+]+/), function(e) {
                                return e.trim();
                            }));
                        } else {
                    ...
                    tagArray = _.map(tagArray, function(e) {
                        if (e.indexOf(".") > -1) {
                            e = e.replace(".", "");
                        }
                        return e.trim();
                ...
                element.bind("keyup", function(e) {
                    var isDot, key, _ref, _ref1;
                    key = e.which;
                    if (key === 9 || key === 13) {
                        e.preventDefault();
                        $scope.$apply("addTag()");
                    }
                    isDot = ((_ref = $scope.tags) != null ? _ref[0] : void 0) === "." || ((_ref1 = $scope.tagVal) != null ? _ref1[0] : void 0) === ".";
                    if (key === 188 && !isDot) {
                        e.preventDefault();
