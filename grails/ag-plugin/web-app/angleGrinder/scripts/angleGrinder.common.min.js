        ...
        return {
            ...
            "$get": [ "$filter", function($filter) {
                return function(date, format) {
                    ...
                    return $filter("agDate")(date, format);
                };
            } ]
        };
    });
...
(function() {
    ...
    ConfirmationDialogCtrl = function(_super) {
        ...
        ConfirmationDialogCtrl.register(app);
    ...
    app.service("confirmationDialog", [ "$modal", "$log", function($modal, $log) {
        return {
...
(function() {
    ...
    NotificationDialogCtrl = function(_super) {
        ...
        NotificationDialogCtrl.register(app);
