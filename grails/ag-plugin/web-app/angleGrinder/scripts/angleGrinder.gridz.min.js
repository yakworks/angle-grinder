(function() {
    var gridz;
    gridz = angular.module("angleGrinder.gridz", [ "ui.router", "angleGrinder.common", "ui.select2" ]);
    ...
    gridz.directive("agGrid", [ "$log", "$parse", "actionPopupHandler", "pathWithContext", function($log, $parse, actionPopupHandler, pathWithContext) {
        var link;
        link = function(scope, element, attrs, gridCtrl) {
            var gridName, gridOptions, initializeGrid, unregister;
            gridCtrl.registerGridElement(element.find("table.gridz"));
            gridName = attrs.agGridName;
            if (gridName) {
                scope[gridName] = gridCtrl;
            }
...
(function() {
    ...
    gridz.directive("agSearchForm", [ "$log", function($log) {
        return {
            ...
            "controller": [ "$scope", "$attrs", "$document", function($scope, $attrs, $document) {
                var gridSearch;
                $scope.filters = {};
                ...
                gridSearch = function(filters) {
                    ...
                    return gridCtrl.search(filters).then(function() {
                        return $scope.searching = false;
                    });
                };
...
(function() {
    ...
    gridz.directive("agShowPagePager", [ "$parse", "$stateParams", "$log", "idsArrayPager", function($parse, $stateParams, $log, idsArrayPager) {
        return {
            "restrict": "A",
            "scope": true,
    ...
    gridz.directive("agGridWithPager", [ "$state", "$log", function($state, $log) {
        return {
            "restrict": "A",
            "require": "^agGrid",
            "link": function(scope, element, attrs, gridCtrl) {
