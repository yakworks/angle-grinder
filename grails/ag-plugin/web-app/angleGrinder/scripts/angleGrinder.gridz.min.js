(function() {
    ...
    gridz.directive("agGrid", [ "$log", "actionPopupHandler", "pathWithContext", function($log, actionPopupHandler, pathWithContext) {
        var link;
        link = function(scope, element, attrs, gridCtrl) {
            var gridName, initializeGrid, unregister;
            ...
            if (element.is(":visible")) {
                return initializeGrid(scope[attrs.agGrid]);
            } else {
