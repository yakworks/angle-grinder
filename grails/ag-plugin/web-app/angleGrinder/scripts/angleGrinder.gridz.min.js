...
(function() {
    ...
    gridz.controller("AgGridCtrl", function() {
        _Class.$inject = [ "$rootScope", "$q", "hasSearchFilters", "flatten", "xlsData" ];
        function _Class($rootScope, $q, hasSearchFilters, flatten, xlsData) {
        ...
        _Class.prototype.getXlsDataUri = function() {
