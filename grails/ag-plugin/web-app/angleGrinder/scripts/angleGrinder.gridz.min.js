...
(function() {
    var Gridz, currencyUnformatter, _ref, _ref1, __indexOf = [].indexOf || function(item) {
...
(function() {
    ...
    gridz = angular.module("angleGrinder.gridz");
    gridz.directive("agGridXlsExport", [ "$window", "NotificationDialogServ", "$compile", "$filter", function($window, NotificationDialogServ, $compile, $filter) {
        return {
            "restrict": "A",
            "link": function(scope, element, attrs) {
                var cellFormatter, exp;
                    ...
                    if (grid.getSelectedRowIds().length !== 0) {
                        if ($window.navigator.userAgent.indexOf("MSIE ") > 0 || !!$window.navigator.userAgent.match(/Trident.*rv\:11\./)) {
                            ...
                            _.each(colMod, function(row) {
                                ...
                                if (_ref = row.name, __indexOf.call(exclude, _ref) < 0) {
