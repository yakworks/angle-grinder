(function() {
    ...
    gridz.directive("agGrid", [ "$log", "$parse", "actionPopupHandler", "pathWithContext", "camelize", function($log, $parse, actionPopupHandler, pathWithContext, camelize) {
        var link;
        link = function(scope, element, attrs, controller) {
            ...
            initializeGrid = function() {
                ...
                $grid.gridz(options);
                return actionPopupHandler($grid, scope);
            };
...
(function() {
    ...
    gridz.controller("AgGridCtrl", function() {
        ...
        _Class.prototype.registerGridElement = function($grid) {
            var _this = this;
            this.$grid = $grid;
            return this.$grid.on("jqGridAfterLoadComplete", function(event, data) {
                return _this.$rootScope.$broadcast("gridz:loadComplete", event, data);
            });
        };
        ...
        _Class.prototype.reload = function(callback) {
            ...
            unregister = this.$rootScope.$on("gridz:loadComplete", function(_, event, data) {
                callback(event, data);
                return unregister();
            });
        ...
        _Class.prototype.prevPage = function(callback) {
            var page;
            if (callback == null) {
                callback = function() {};
            }
            ...
            if (page === 1) {
                return this.lastPage(callback);
            }
            return this.loadPage(page - 1, callback);
        };
        _Class.prototype.nextPage = function(callback) {
            var page;
            if (callback == null) {
                callback = function() {};
            }
            ...
            if (page === this.getTotalPages()) {
                return this.firstPage(callback);
            }
            return this.loadPage(page + 1, callback);
        };
        _Class.prototype.firstPage = function(callback) {
            if (callback == null) {
                callback = angular.noop;
            }
            return this.loadPage(1, callback);
        };
        _Class.prototype.lastPage = function(callback) {
            if (callback == null) {
                callback = angular.noop;
            }
            return this.loadPage(this.getTotalPages(), callback);
        };
        _Class.prototype.loadPage = function(page, callback) {
            if (callback == null) {
                callback = function() {};
            }
            this.setParam({
...
(function() {
    ...
    gridz.directive("agSearchForm", [ "$log", function($log) {
        return {
            ...
            "controller": [ "$scope", "$parse", "$attrs", "$document", function($scope, $parse, $attrs, $document) {
                var gridSearch;
                $scope.filters = {};
                ...
                gridSearch = function(filters) {
                    ...
                    return grid.search(filters).then(function() {
                        return $scope.searching = false;
                    });
                };
                $scope.advancedSearch = function(filters) {
                    ...
                    if (formCtrl != null ? formCtrl.$invalid : void 0) {
                        return $log.info("advanced search form is invalid", formCtrl);
                    }
...
(function() {
    ...
    mixin.controller("gridPagerCtrlMixin", [ "$log", "$scope", "$parse", "$location", "gridName", "currentId", "path", function($log, $scope, $parse, $location, gridName, currentId, path) {
        ...
        prevGridPage = function(callback) {
            var grid;
            grid = $parse(gridName)($scope);
            return grid.prevPage(function() {
                var ids;
                ids = getGridIds();
        ...
        nextGridPage = function(callback) {
            var grid;
            grid = $parse(gridName)($scope);
            return grid.nextPage(function() {
                var ids;
                ids = getGridIds();
        ...
        this.prevRow = function() {
            ...
            if (indx > 0) {
                ...
                return prevGridPage(function(ids) {
        ...
        this.nextRow = function() {
            ...
            if (indx < ids.length - 1) {
                ...
                return nextGridPage(function(ids) {
