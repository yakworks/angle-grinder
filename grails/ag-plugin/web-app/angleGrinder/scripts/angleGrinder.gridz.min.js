    ...
    gridz.directive("agGrid", [ "$log", "$parse", "agGridDataLoader", "actionPopupHandler", "pathWithContext", "camelize", function($log, $parse, agGridDataLoader, actionPopupHandler, pathWithContext, camelize) {
        ...
        link = function(scope, element, attrs, gridCtrl) {
            ...
            initializeGrid = function() {
                ...
                return actionPopupHandler(gridEl, scope, attrs);
            };
...
(function() {
    ...
    AgGridCtrl = function(_super) {
        ...
        AgGridCtrl.inject("$rootScope", "$element", "$attrs", "$q", "hasSearchFilters", "flatten", "xlsData", "csvData");
        ...
        AgGridCtrl.prototype.addClass = function(id, clazz) {
            var rowEl;
            rowEl = $(this.getGridEl()[0].rows.namedItem(id));
            rowEl.delay(250).fadeOut("medium", function() {
        ...
        AgGridCtrl.prototype.removeClass = function(id, clazz) {
            var rowEl;
            rowEl = $(this.getGridEl()[0].rows.namedItem(id));
            rowEl.delay(250).fadeOut("medium", function() {
                if (rowEl.hasClass(clazz)) {
...
(function() {
    ...
    gridz.directive("agReloadGrid", [ function() {
        return {
            ...
            "template": '<a class="list" ng-click="reload()"><i class="icon-refresh"></i></a>'
        };
    } ]);
}).call(this);
...
(function() {
    ...
    gridz.directive("agGridXlsExport", [ "$window", "notificationDialog", function($window, notificationDialog) {
        return {
            "restrict": "A",
            "link": function(scope, element, attrs) {
                return element.on("click", function(event) {
                    ...
                    if (grid.getSelectedRowIds().length !== 0) {
                        ...
                        return notificationDialog.open("Please select at least one row.");
                    }
                });
            }
        };
...
(function() {
    var gridz;
    gridz = angular.module("angleGrinder.gridz");
    gridz.value("applyFormatters", function(colModel, formatters) {
        if (formatters == null) {
            formatters = {};
        }
...
(function() {
    var gridz;
    gridz = angular.module("angleGrinder.gridz");
    gridz.service("gridLinkServ", [ "pathWithContext", "flatten", function(pathWithContext, flatten) {
...
(function() {
    ...
    app.directive("gridCrud", [ "$controller", function($controller) {
        return {
            "restrict": "A",
            "replace": true,
            "scope": true,
...
(function() {
    this.GridCrudCtrl = function() {
        ...
        function GridCrudCtrl($scope, $element, $attrs, $parse, $log, resourceBuilder, $window) {
            var Resource, actionSuffix, afterSave, beforeSave, createAction, editAction, grid, hideForm, resourceName, showForm;
            Resource = null;
            beforeSave = null;
            afterSave = null;
            if ($attrs.beforeSave) {
