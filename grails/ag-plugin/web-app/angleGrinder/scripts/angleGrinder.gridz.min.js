...
(function() {
    ...
    gridz.directive("agGridXlsExport", [ "$window", "notificationDialog", "$compile", function($window, notificationDialog, $compile) {
        return {
            "restrict": "A",
            "link": function(scope, element, attrs) {
                var exp;
...
(function() {
    this.GridCrudCtrl = function() {
        GridCrudCtrl.$inject = [ "$scope", "$element", "$attrs", "$parse", "$log", "resourceBuilder", "$window", "restrictResource" ];
        function GridCrudCtrl($scope, $element, $attrs, $parse, $log, resourceBuilder, $window, restrictResource) {
