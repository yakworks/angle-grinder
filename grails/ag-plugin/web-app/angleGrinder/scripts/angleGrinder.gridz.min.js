...
(function() {
    ...
    gridz.controller("AgGridCtrl", function() {
        ...
        _Class.prototype.registerGridElement = function(gridEl) {
            this.gridEl = gridEl;
        };
        _Class.prototype.getGridId = function() {
            return this.gridEl.attr("id");
        };
        ...
        _Class.prototype.getRowData = function(rowId) {
            ...
            return this.gridEl.getRowData(rowId);
        };
        _Class.prototype.addJSONData = function(data) {
            this.gridEl.get(0).addJSONData(data);
        ...
        _Class.prototype.getParam = function(name) {
            return this.gridEl.getGridParam(name);
        };
        _Class.prototype.setParam = function(params) {
            return this.gridEl.setGridParam(params);
        };
        _Class.prototype.updateRow = function(id, data) {
            ...
            this.gridEl.setRowData(id, flatData);
        ...
        _Class.prototype.isFirstPage = function() {
            var page;
            page = this.getCurrentPage();
            return page === 1;
        };
        _Class.prototype.isLastPage = function() {
            var page;
            page = this.getCurrentPage();
        ...
        _Class.prototype.removeRow = function(id) {
            return this.flashOnSuccess(id, function(_this) {
                return function() {
                    return _this.gridEl.delRowData(id);
                };
            }(this));
        };
        ...
        _Class.prototype.toggleColumn = function(columnId) {
            ...
            this.gridEl.jqGrid(showOrHide, columnId);
        ...
        _Class.prototype.columnChooser = function(options) {
            ...
            options.done = function(_this) {
                return function(perm) {
                    var choosedColumns;
                    if (perm) {
                        _this.gridEl.jqGrid("remapColumns", perm, true);
                    }
            ...
            return this.gridEl.jqGrid("columnChooser", options);
        };
        _Class.prototype._triggerResize = function() {
            return this.gridEl.trigger("resize");
        };
        ...
        _Class.prototype._flashRow = function(id, color, complete) {
            ...
            rowEl = $(this.gridEl[0].rows.namedItem(id));
...
(function() {
    ...
    gridz.service("xlsData", [ "$document", "$sanitize", "xlsTemplate", function($document, $sanitize, xlsTemplate) {
        ...
        findGridEl = function(grid) {
            var gridId;
            gridId = grid.getGridId();
            return [ gridId, $document.find("div#gbox_" + gridId) ];
        };
        prepareHeading = function(grid) {
            var el, gridEl, gridId, _ref;
            _ref = findGridEl(grid), gridId = _ref[0], gridEl = _ref[1];
        ...
        prepareRows = function(grid) {
            var el, gridEl, gridId, rowIds, _ref;
            _ref = findGridEl(grid), gridId = _ref[0], gridEl = _ref[1];
