...
(function(factory) {
    ...
    $.widget("blueimp.fileupload", {
        ...
        _initXHRData: function(options) {
            var that = this, formData, file = options.files[0], multipart = options.multipart || !$.support.xhrFileUpload, paramName = options.paramName[0];
        ...
        _onAdd: function(e, data) {
            ...
            if (!(options.singleFileUploads || limit || limitSize) || !this._isXHRUpload(options)) {
                ...
                for (i = 0; i < filesLength; i = i + 1) {
                    ...
                    if (i + 1 === filesLength || batchSize + files[i + 1].size + overhead > limitSize) {
