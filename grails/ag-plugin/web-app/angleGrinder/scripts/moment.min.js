(function(undefined) {
        ...
        return moment.lang("cv", {
            ...
            "relativeTime": {
                "future": function(output) {
                    var affix = /\u0441\u0435\u0445\u0435\u0442$/i.exec(output) ? "\u0440\u0435\u043d" : /\xe7\u0443\u043b$/i.exec(output) ? "\u0442\u0430\u043d" : "\u0440\u0430\u043d";
                    return output + affix;
                },
                "past": "%s \u043a\u0430\u044f\u043b\u043b\u0430",
                "s": "\u043f\u0115\u0440-\u0438\u043a \xe7\u0435\u043a\u043a\u0443\u043d\u0442",
    ...
    (function(factory) {
        ...
        function processRelativeTime(number, withoutSuffix, key, isFuture) {
            var format = {
                ...
                "MM": [ number + " M\xe9int", number + " M\xe9int" ],
    ...
    (function(factory) {
        ...
        function relativeWeekDay(moment, format) {
            var nominative = format.indexOf("dddd HH:mm") === -1, weekDay = weekDays[moment.weekday()];
