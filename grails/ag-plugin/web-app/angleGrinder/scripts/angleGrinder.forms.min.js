...
(function() {
    var forms;
    forms = angular.module("angleGrinder.forms");
    forms.factory("formDialog", [ "$dialog", "pathWithContext", function($dialog, pathWithContext) {
        return {
            "open": function(templateUrl, item, grid) {
                var dialog;
                ...
                return dialog.open(pathWithContext(templateUrl), "FormDialogCtrl");
            }
        };
    } ]);
}).call(this);
...
(function() {
    ...
    FormDialogCtrl = function() {
        FormDialogCtrl.$inject = [ "$scope", "$rootScope", "$log", "dialog", "serverValidationErrorsHandler", "item", "grid" ];
        function FormDialogCtrl($scope, $rootScope, $log, dialog, serverValidationErrorsHandler, item, grid) {
            $scope.item = item;
...
(function() {
    ...
    mixin.factory("dialogCrudCtrlMixin", [ "$log", "$parse", "formDialog", "confirmationDialog", function($log, $parse, formDialog, confirmationDialog) {
        return function($scope, args) {
            var Resource, getGrid, gridName, openEditDialogFor, templateUrl;
            if (args == null) {
                args = {};
            }
            ...
            openEditDialogFor = function(resource) {
                return formDialog.open(templateUrl, resource, getGrid());
            };
...
(function() {
    var mixin;
    mixin = angular.module("angleGrinder.forms");
    mixin.factory("massUpdateMixin", [ "$log", "$parse", "$dialog", "pathWithContext", function($log, $parse, $dialog, pathWithContext) {
        return function($scope, args) {
