            ...
            "compile": function(element, attrs) {
                ...
                markAsSubmitted = function(form) {
                    ...
                    nestedForms = _.filter(_.values(form), function(input) {
                        return input instanceof form.constructor && __indexOf.call(forms, form) < 0;
                    });
                    _results = [];
...
(function() {
    ...
    forms.directive("agLength", [ "IsFalsyServ", "$parse", function(IsFalsyServ, $parse) {
        return {
            "require": "ngModel",
            "restrict": "A",
            "link": function(scope, elem, attrs, ngModelCtrl) {
                ...
                lengthValidator = function(value) {
                    ...
                    valid = IsFalsyServ(length) || !ngModelCtrl.$isEmpty(value) && value.length === length;
...
(function() {
    ...
    mixin.factory("DialogCrudCtrlMixin", [ "$log", "$parse", "FormDialogServ", "ConfirmationDialogServ", function($log, $parse, FormDialogServ, ConfirmationDialogServ) {
