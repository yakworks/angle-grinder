...
(function() {
    ...
    forms.directive("editableDatepicker", [ "editableDirectiveFactory", "$filter", function(editableDirectiveFactory, $filter) {
        return editableDirectiveFactory({
            ...
            "inputTpl": '<input type="text" ng-model="$data" datepicker-popup="MM/dd/yyyy" is-open="opened" ng-readonly="disabled">',
            "render": function() {
                var div;
                this.parent.render.call(this);
                div = angular.element('<div class="input-prepend"></div>');
                this.inputEl.wrap(div);
                return this.inputEl.after('<button type="button" class="btn btn-default" ng-click="open($event)" ng-disabled="disabled">\n  <i class="fa fa-calendar"></i>\n</button>');
            },
            "init": function() {
