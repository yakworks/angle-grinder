...
(function() {
    ...
    mixin.factory("dialogCrudCtrlMixin", [ "$log", "$parse", "editDialog", "confirmationDialog", "pathWithContext", function($log, $parse, editDialog, confirmationDialog, pathWithContext) {
        return function($scope, args) {
            ...
            openEditDialogFor = function(resource) {
                return editDialog.open(pathWithContext(templateUrl), resource, getGrid());
            };
