...
(function() {
    ...
    forms.directive("agTabset", function() {
        return {
            ...
            "transclude": true,
            "scope": true,
            "controller": [ "$scope", "pathWithContext", function($scope, pathWithContext) {
                $scope.tabs = [];
                $scope.currentTemplateUrl = function() {
                    var selectedTab;
                    selectedTab = _.findWhere($scope.tabs, {
                        "selected": true
                    });
                    if (selectedTab != null) {
                        return pathWithContext(selectedTab.templateUrl);
                    }
                };
    ...
    forms.directive("agTab", [ function() {
        return {
            "restrict": "E",
            "replace": true,
            "require": "^agTabset",
            ...
            "template": '<li ng-click="select()" ng-class="{active: selected}">\n  <a href="" ng-transclude>{{heading}}</a>\n</li>'
        };
    } ]);
}).call(this);
    ...
    forms.directive("agPanelsRow", function() {
        return {
            ...
            "controller": [ "$log", "$scope", "$element", "$timeout", function($log, $scope, $element, $timeout) {
                var equalizeHeights, unregister, _this = this;
                this.panels = [];
                equalizeHeights = function() {
                    var $panel, heights, maxHeight, paddings, _i, _len, _ref, _results;
                    ...
                    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                        ...
                        _results.push($panel.find(".panel-body").css("min-height", maxHeight - paddings));
                    }
                    return _results;
                };
...
(function() {
    ...
    mixin.factory("dialogCrudCtrlMixin", [ "$log", "editDialog", "confirmationDialog", "pathWithContext", function($log, editDialog, confirmationDialog, pathWithContext) {
        return function($scope, args) {
            var Resource, gridName, openEditDialogFor, templateUrl;
            if (args == null) {
                args = {};
            }
            Resource = args.Resource, gridName = args.gridName, templateUrl = args.templateUrl;
            openEditDialogFor = function(resource) {
                var grid;
                grid = $scope[gridName];
                return editDialog.open(pathWithContext(templateUrl), resource, grid);
            };
            $scope.editItem = function(id) {
                return Resource.get({
                    "id": id
                }, function(resource) {
                    if (args.beforeEdit != null) {
                        resource = args.beforeEdit(resource);
                    }
            ...
            $scope.createItem = function() {
                ...
                if (args.beforeCreate != null) {
                    resource = args.beforeCreate(resource);
                }
                return openEditDialogFor(resource);
            };
            return $scope.deleteItem = function(id) {
                return confirmationDialog.open().then(function(confirmed) {
                    ...
                    onSuccess = function(response) {
                        var grid;
                        grid = $scope[gridName];
                        return grid.removeRow(response.id);
                    };
                    onError = function(response) {
