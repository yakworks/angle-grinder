(function() {
    ...
    angular.module("ui.bootstrap.datepicker").config([ "$provide", function($provide) {
        return $provide.decorator("daypickerDirective", function($delegate) {
...
(function() {
    var ConfirmationDialogCtrl, forms, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
        for (var key in parent) {
            if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
        function ctor() {
    ...
    ConfirmationDialogCtrl = function(_super) {
        ...
        ConfirmationDialogCtrl.inject("$scope", "$modalInstance", "$log", "options");
    ...
    forms.service("confirmationDialog", [ "$modal", "$log", function($modal, $log) {
        return {
...
(function() {
    var ConfirmationDialog, NotificationDialogCtrl, forms, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
        for (var key in parent) {
            if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
        function ctor() {
    ...
    NotificationDialogCtrl = function(_super) {
        ...
        NotificationDialogCtrl.register(forms);
