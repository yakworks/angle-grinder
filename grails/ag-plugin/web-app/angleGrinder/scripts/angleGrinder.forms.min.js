...
(function() {
    ...
    FormDialogCtrl = function() {
        FormDialogCtrl.$inject = [ "$scope", "$rootScope", "$log", "dialog", "serverValidationErrorsHandler", "dialogOptions" ];
        function FormDialogCtrl($scope, $rootScope, $log, dialog, serverValidationErrorsHandler, dialogOptions) {
            var grid, item, _ref;
