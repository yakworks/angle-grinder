(function() {
    ...
    forms = angular.module("angleGrinder.forms", [ "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.dateparser", "ui.bootstrap.position", "ui.bootstrap.dropdown", "ui.bootstrap.stackedMap", "ui.bootstrap.modal", "ui.bootstrap.pagination", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.tpls", "xeditable", "angleGrinder.common", "angleGrinder.alerts" ]);
        ...
        return {
            ...
            "link": function(scope, element, attrs, ngModelCtrl) {
                ...
                ngModelCtrl.$parsers.push(function(viewValue) {
                    ...
                    if (isValid) {
                        return moment(viewValue).format(modelFormat);
                    } else {
                        return "";
                    }
                });
                ...
                transcludeFn(scope, function(cloneContent) {
                    return angular.forEach(cloneContent, function(element) {
                        ...
                        if (element instanceof HTMLElement) {
                            ...
                            return buttons.prepend(li.append(angular.element($compile(element)(scope))));
                        }
                    });
                });
                return element.prepend(buttons);
            }
        };
    } ]);
