(function() {
    ...
    forms = angular.module("angleGrinder.forms", [ "ui.bootstrap", "xeditable", "angleGrinder.common" ]);
...
(function() {
    ...
    forms.directive("editableDatepicker", [ "editableDirectiveFactory", function(editableDirectiveFactory) {
        return editableDirectiveFactory({
            ...
            "render": function() {
                ...
                return this.inputEl.after('<button type="button" class="btn btn-default" ng-click="open($event)">\n  <i class="fa fa-calendar"></i>\n</button>');
            },
            "init": function() {
