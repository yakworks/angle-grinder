...
(function() {
    ...
    Gridz = function() {
        ...
        Gridz.prototype.addRowActionColumn = function() {
            ...
            this.options.colModel = _.reject(this.options.colModel, function(col) {
                return col.name === "-row_action_col";
            });
    ...
    $.extend($.fn.fmatter, {
        "date": function(cellVal) {
            return window.agDateFilter(cellVal);
        },
        "currency": function(cellVal) {
            return window.agCurrencyFilter(cellVal);
        },
