...
First set the defaults to allow nulls for domains
----
show the setting to allow nulls by default
----
...
=== Functional GEB?? tests for our REST CRUD
* write tests for the Create,Read,Update,Delete and List more or less based on the above curl examples
* this says its built into 3 somehow https://grails.org/plugin/rest-client-builder
* this has some possible examples http://aruizca.com/integrated-vs-functional-testing-how-to-test-rest-apis-in-grails-using-spock/
* I put together step by step for Geb in grails 3 here https://github.com/basejump/grails3-geb-example
* show test

=== Snapshot 1 sample app saved
...
Add in the dependencie for the plugin
----
show the dep line
----
