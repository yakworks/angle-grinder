  ...
  function($uibModal) {
    return {
      ...
      link: function($scope, elem, attrs) {
        var cropObj; var oldCropObj; var oldOriginalCropObj; var openModal = false; var isCancel = false
        ...
        var loadImage = function(e) {
          if (!e) {
            ...
            var previewToLoad = new Image(); var isError = false; var errorType
              ...
              if (isError) {
                if ($scope.options == oldOriginalCropObj) {
                  ...
                  if (oldCropObj) {
                    ...
                    if (!$scope.tempOptions) { delete $scope.options }
                  }
                }
        ...
        if ((typeof cropObj !== 'undefined' && cropObj !== null)) {
          if ((typeof cropObj.url !== 'undefined' && cropObj.url !== null)) { loadImage() }
        }
...
app.controller('ModalCropCtrl', function($scope, $uibModalInstance, $compile, $window, crop) {
  ...
  angular.element(imageToLoad).bind('load', function() {
    if (imageToLoad.width < $scope.optionsCrop.cropMinWidth) {
      ...
      var boxWidth = 850; var newWidth; var newHeight; var startPoint = $scope.optionsCrop.cropMinWidth ? $scope.optionsCrop.cropMinWidth : 1; var startPointWidth; var startPointHeight

      if (boxWidth < $scope.optionsCrop.cropMinWidth) { boxWidth = $scope.optionsCrop.cropMinWidth }
      ...
      var initJcrop = function(w, h) {
        var maxW = $scope.optionsCrop.cropMaxWidth; var maxH = $scope.optionsCrop.cropMaxHeight; var minW = $scope.optionsCrop.cropMinWidth; var minH = $scope.optionsCrop.cropMinHeight; var allowResize = true
        if (maxW == 0) {
