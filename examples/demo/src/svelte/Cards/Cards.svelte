<script>
  import { BlockTitle, Button, Card, CardHeader, CardTitle, CardContent, CardSubtitle, Columns, Col } from '@yakit/ui'
...
<Col>
  <Card>
    ...
    <hr>
    <CardContent>Greyhound fantastic hello coldly wonderfully marginally far upon universe.</CardContent>
  </Card>
</Col>
<Col>
...
<Col>
  <Card>
    <CardHeader title="Header with Button">
