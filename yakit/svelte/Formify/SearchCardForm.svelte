...
<script>
  ...
  export let fieldConfig = transformFields(searchConfig)
...
<ListForm name="list-form-example1" formOnly={true} {initData} bind:data bind:formContext>
  <Card class="m-0 bg-body-low" >
    <CardContent class="p0">

  <div class="tile is-ancestor">
    {#each fieldConfig.columns as colCfg}
