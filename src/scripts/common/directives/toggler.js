...
app.factory('ToggleHelper', function ($rootScope) {
  return {
...
.directive('toggler', function ($rootScope, ToggleHelper) {
  return {
    ...
    link: function (scope, elem, attrs) {
      let options = scope.$eval(attrs.toggler) || {id: attrs.toggler}
      ...
      if (!(tagetId || targetClass)) {
        throw "'id' or 'class' property required with 'toggler'"
      }
