...
export class StringUtility {
	...
	*/
	checkPassword(password) {
		...
		let upperCount = this.countContain(password, UpperCase);
		let lowerCount = this.countContain(password, LowerCase);
		let lowerUpperCount = upperCount + lowerCount;
		...
		let numberCount = this.countContain(password, Numbers);
		...
		let characterCount = this.countContain(password, Characters);
...
let stringFormUtils = new StringUtility()
