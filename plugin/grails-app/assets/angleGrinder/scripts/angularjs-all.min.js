        ...
        this.$get = [ "$injector", "$window", function($injector, $window) {
            return function(expression, locals, later, ident) {
                ...
                if (isString(expression)) {
                    ...
                    console.log(match[1]);
                    console.log(identifier || match[3]);
...
angular.module("ui.bootstrap.alert", []).controller("UibAlertController", [ "$scope", "$attrs", "$timeout", function($scope, $attrs, $timeout) {
...
angular.module("ui.bootstrap.datepicker", [ "ui.bootstrap.dateparser", "ui.bootstrap.position" ]).value("$datepickerSuppressError", false).constant("uibDatepickerConfig", {
    ...
    this._refreshView = function() {
        var year = this.activeDate.getFullYear(), month = this.activeDate.getMonth(), firstDayOfMonth = new Date(year, month, 1), difference = this.startingDay - firstDayOfMonth.getDay(), numDisplayedFromPreviousMonth = difference > 0 ? 7 - difference : -difference, firstDate = new Date(firstDayOfMonth);
    ...
    var dateFormat, closeOnDateSelection, appendToBody, onOpenFocus, datepickerPopupTemplateUrl, datepickerTemplateUrl, popupEl, datepickerEl, ngModel, $popup;
    scope.watchData = {};
...
angular.module("ui.bootstrap.datepicker").value("$datepickerSuppressWarning", false).controller("DatepickerController", [ "$scope", "$attrs", "$log", "$datepickerSuppressWarning", "$controller", function($scope, $attrs, $log, $datepickerSuppressWarning, $controller) {
...
angular.module("ui.bootstrap.dropdown", [ "ui.bootstrap.position" ]).constant("uibDropdownConfig", {
    ...
    var self = this, scope = $scope.$new(), templateScope, openClass = dropdownConfig.openClass, getIsOpen, setIsOpen = angular.noop, toggleInvoker = $attrs.onToggle ? $parse($attrs.onToggle) : angular.noop, appendToBody = false, keynavEnabled = false, selectedOption = null;
...
angular.module("ui.bootstrap.modal", [ "ui.bootstrap.stackedMap" ]).factory("$$multiMap", function() {
    ...
    var $modalProvider = {
        ...
        "$get": [ "$injector", "$rootScope", "$q", "$templateRequest", "$controller", "$uibModalStack", function($injector, $rootScope, $q, $templateRequest, $controller, $modalStack) {
            var $modal = {};
...
angular.module("ui.bootstrap.pagination").value("$paginationSuppressWarning", false).controller("PaginationController", [ "$scope", "$attrs", "$parse", "$controller", "$element", "$log", "$paginationSuppressWarning", function($scope, $attrs, $parse, $controller, $element, $log, $paginationSuppressWarning) {
...
angular.module("ui.bootstrap.tooltip", [ "ui.bootstrap.position", "ui.bootstrap.stackedMap" ]).provider("$uibTooltip", function() {
    ...
    this.$get = [ "$window", "$compile", "$timeout", "$document", "$uibPosition", "$interpolate", "$rootScope", "$parse", "$$stackedMap", function($window, $compile, $timeout, $document, $position, $interpolate, $rootScope, $parse, $$stackedMap) {
        ...
        return function $tooltip(ttType, prefix, defaultTriggerShow, options) {
            ...
            var template = "<div " + directiveName + "-popup " + 'title="' + startSym + "title" + endSym + '" ' + (options.useContentExp ? 'content-exp="contentExp()" ' : 'content="' + startSym + "content" + endSym + '" ') + 'placement="' + startSym + "placement" + endSym + '" ' + 'popup-class="' + startSym + "popupClass" + endSym + '" ' + 'animation="animation" ' + 'is-open="isOpen"' + 'origin-scope="origScope" ' + 'style="visibility: hidden; display: block;"' + ">" + "</div>";
            return {
...
angular.module("ui.bootstrap.progressbar").value("$progressSuppressWarning", false).controller("ProgressController", [ "$scope", "$attrs", "$controller", "$log", "$progressSuppressWarning", function($scope, $attrs, $controller, $log, $progressSuppressWarning) {
...
angular.module("ui.bootstrap.timepicker").value("$timepickerSuppressWarning", false).controller("TimepickerController", [ "$scope", "$attrs", "$controller", "$log", "$timepickerSuppressWarning", function($scope, $attrs, $controller, $log, $timepickerSuppressWarning) {
...
} ]).directive("uibTypeahead", [ "$compile", "$parse", "$q", "$timeout", "$document", "$window", "$rootScope", "$uibPosition", "uibTypeaheadParser", function($compile, $parse, $q, $timeout, $document, $window, $rootScope, $position, typeaheadParser) {
        ...
        return function(scope, element, attr) {
            ...
            function getMimeType(types) {
                ...
                for (var i = 0; i < types.length; i++) {
                    if (types[i] == MSIE_MIME_TYPE || types[i] == EDGE_MIME_TYPE || types[i].substr(0, MIME_TYPE.length) == MIME_TYPE) {
                        return types[i];
                    }
                }
                return null;
...
(function() {
    ...
    this.BaseCtrl = function() {
        ...
        function BaseCtrl() {
            ...
            console.log(this.constructor.annotations);
