(function() {
    ...
    AlertsCtrl = function() {
        ...
        function AlertsCtrl($scope, alerts) {
            ...
            this.$scope = $scope;
            this.alerts = alerts;
            this.$scope.alertMessages = this.alerts.messages;
            this.$scope.disposeAlert = function(id) {
                return _this.alerts.dispose(id);
            };
        }
        return AlertsCtrl;
    }();
