...
(function() {
    var app;
    app = angular.module("angleGrinder", [ "angleGrinder.common", "angleGrinder.gridz", "angleGrinder.forms", "angleGrinder.alerts", "angleGrinder.dataGenerator", "angleGrinder.resources", "angleGrinder.spinner" ]);
...
(function() {
    var SearchFormCtrl, ServerSideCtrl;
    ServerSideCtrl = function() {
        ServerSideCtrl.$inject = [ "$scope", "$log", "$dialog", "confirmationDialog", "editDialog", "Users", "pathWithContext" ];
        function ServerSideCtrl($scope, $log, $dialog, confirmationDialog, editDialog, Users, pathWithContext) {
            ...
            $scope.editItem = function(id) {
                return Users.get({
                    ...
                    return editDialog.open(pathWithContext("templates/partials/user_form.html"), user);
                });
            };
            $scope.createItem = function() {
                var user;
    ...
    angular.module("angleGrinder").controller("ServerSideCtrl", ServerSideCtrl).controller("SearchFormCtrl", SearchFormCtrl);
}).call(this);
...
(function() {
    var ListCtrl;
    ListCtrl = function() {
        ListCtrl.$inject = [ "$scope", "$location", "pathWithContext" ];
        function ListCtrl($scope, $location, pathWithContext) {
            $scope.gridOptions = {
                url: pathWithContext("/api/users"),
                colModel: this.gridColumns(),
                rowNum: 10,
            ...
            $scope.deleteItem = function(id) {
                return console.log("deleting id:", id);
            };
        }
            ...
            $scope.save = function(user) {
                ...
                onError = function(response) {
                    ...
                    if (response.status === 422) {
                        ...
                        return $scope.serverValidationErrors = errors;
                    }
                };
                return user.save({
                    success: onSuccess,
