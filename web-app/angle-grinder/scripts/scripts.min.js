...
(function() {
    var app;
    app = angular.module("angleGrinder", [ "angleGrinder.common", "angleGrinder.gridz", "angleGrinder.forms", "angleGrinder.alerts", "angleGrinder.dataGenerator", "angleGrinder.resources", "angleGrinder.spinner", "ui.select2" ]);
...
(function() {
    ...
    SearchFormCtrl = function() {
        SearchFormCtrl.$inject = [ "$scope", "$rootScope", "$element" ];
        function SearchFormCtrl($scope, $rootScope, $element) {
            $scope.openOrgSelect = function() {
                return $element.find("#orgSelect2").select2("open");
            };
