    ...
    resources.factory("Users", [ "$resource", function($resource) {
        ...
        angular.extend(Users.prototype, {
            ...
            save: function(onComplete) {
                ...
                if (this.persisted()) {
                    return this.$update(onComplete);
                } else {
                    return this.$save(onComplete);
                }
            },
...
(function() {
    ...
    app = angular.module("angleGrinder", [ "angleGrinder.templates", "angleGrinder.gridz", "angleGrinder.forms", "angleGrinder.dataGenerator", "angleGrinder.resources" ]);
    app.config([ "$provide", "$routeProvider", function($provide, $routeProvider) {
        $provide.value("alertTimeout", 3e3);
...
(function() {
    ...
    ServerSideCtrl = function() {
        ServerSideCtrl.$inject = [ "$scope", "editDialog", "Users" ];
        function ServerSideCtrl($scope, editDialog, Users) {
            $scope.gridOptions = {
                url: "/api/users",
                colModel: this.gridColumns(),
                rowNum: 10,
            ...
            $scope.deleteItem = function(id) {
                ...
                return user.$delete(function() {
                    return $scope.$broadcast("itemDeleted");
                });
            };
