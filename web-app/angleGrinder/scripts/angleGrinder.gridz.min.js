(function() {
    ...
    gridz.directive("agGrid", [ "$log", function($log) {
        var link;
...
(function() {
    ...
    gridz.directive("agSearchButton", function() {
        return {
            restrict: "E",
            replace: true,
            template: '<button type="button" ng-click="advancedSearch(filters)" ng-disabled="!promise" class="btn btn-info">\n  <i class="icon-search icon-white"></i> Search<span ng-show="!promise">...</span>\n</button>'
        };
    });
            ...
            compile: function($element, attrs, transclude) {
                ...
                return {
                    pre: function($scope, element, attrs) {
                        ...
                        return options.formatSelection || (options.formatSelection = function(item) {
                            return item.name;
                        });
                    }
                };
