...
(function() {
    var ListCtrl;
    ListCtrl = function() {
        ListCtrl.$inject = [ "$scope", "$location", "$filter", "pathWithContext" ];
        function ListCtrl($scope, $location, $filter, pathWithContext) {
            this.$filter = $filter;
            $scope.gridOptions = {
                url: pathWithContext("/api/users"),
                colModel: this.gridColumns(),
