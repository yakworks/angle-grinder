    ...
    UsersListCtrl = function() {
        ...
        function UsersListCtrl($scope, $log, $dialog, $filter, confirmationDialog, editDialog, Users, pathWithContext) {
            ...
            $scope.editItem = function(id) {
                ...
                return editDialog.open(pathWithContext("templates/partials/userForm.html"), promise);
            };
            $scope.createItem = function() {
                var user;
                user = new Users();
...
(function() {
    var ListCtrl;
    ListCtrl = function() {
        ListCtrl.$inject = [ "$scope", "$location", "$filter", "$dialog", "pathWithContext" ];
        function ListCtrl($scope, $location, $filter, $dialog, pathWithContext) {
            this.$filter = $filter;
            $scope.gridOptions = {
                url: pathWithContext("/api/users"),
                colModel: this.gridColumns(),
